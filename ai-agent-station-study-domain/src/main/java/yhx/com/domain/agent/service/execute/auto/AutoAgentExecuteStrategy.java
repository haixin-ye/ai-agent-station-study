package yhx.com.domain.agent.service.execute.auto;
...
import yhx.com.domain.agent.service.execute.IExecuteStrategy;
import yhx.com.domain.agent.service.execute.auto.step.AbstractExecuteSupport;
import yhx.com.domain.agent.service.execute.auto.step.factory.DefaultAutoAgentExecuteStrategyFactory;
import yhx.com.domain.agent.service.execute.auto.support.AutoAgentTraceLogSupport;
...
public class AutoAgentExecuteStrategy implements IExecuteStrategy {
    ...
    public void execute(ExecuteCommandEntity executeCommandEntity, ResponseBodyEmitter emitter) throws Exception {
        ...
        log.info("AutoAgent execution finished: {}", apply);
        ...
        try {
            ...
            log.error("Failed to send AutoAgent completion event: {}", e.getMessage(), e);
        }
    }
