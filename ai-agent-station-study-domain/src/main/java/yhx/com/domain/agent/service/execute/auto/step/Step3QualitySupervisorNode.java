...
import yhx.com.domain.agent.model.entity.AcceptedResultVO;
...
import yhx.com.domain.agent.model.entity.NextRoundDirectiveVO;
...
import yhx.com.domain.agent.model.valobj.enums.OverallStateEnumVO;
...
public class Step3QualitySupervisorNode extends AbstractExecuteSupport {
    ...
    static void applyDecisionToContext(DefaultAutoAgentExecuteStrategyFactory.DynamicContext dynamicContext,
        ...
        dynamicContext.getRoundArchive().computeIfAbsent(round, key ->
                yhx.com.domain.agent.model.entity.RoundArchiveVO.builder().round(round).build())
