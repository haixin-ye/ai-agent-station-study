package yhx.com.test.spring.ai;

import yhx.com.test.spring.ai.advisors.RagAnswerAdvisor;
...
public class AutoAgentTest {
    ...
    public McpSyncClient stdioMcpClient() {
        var stdioParams = ServerParameters.builder("D:\\software\\nodejs\\npx.cmd")
                .args("-y", "@modelcontextprotocol/server-filesystem", "D:\\YHX\\Desktop", "E:\\javaProject\\ai-agent-station-study\\ai-agent-station-study-app")
                .build();
    ...
    public McpSyncClient sseMcpClient() {
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://appbuilder.baidu.com/v2/ai_search/mcp/")
                .sseEndpoint("sse?api_key=bce-v3/ALTAK-oACkdcBrv9k3AzEB88B1M/f2b0a6ad1e63ff70b49cdb3770684f68b69971f0")
                .build();
