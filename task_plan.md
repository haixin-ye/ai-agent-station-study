...
- [x] Thirteenth checkpoint committed: `a6a2486` (`agent: add rag runtime verification`), covering explicit RAG retrieval execution, query/hit/payload/evidence persistence, bounded `RagVerifierInput`, fact-triggered `RagVerifier`, and RAG recovery mapping.
